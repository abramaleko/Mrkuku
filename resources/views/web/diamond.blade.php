    ...
    <section class="mx-8 mt-8 lg:ml-10">
        ...
        <div class="mt-4 other-benefits">
            ...
            <ul class="text-lg font-light text-gray-600 list-disc list-outside">
                ...
                <li class="py-2">
                    If you will not withdraw your ROI (10%) in 6 months which is a total of 60% ROI, a bonus of 40% from the
                    60% ROI will be awarded
                </li>

                <li class="py-2">
                    If you will not withdraw your ROI (10%) in 12 months which is a total of 120% ROI, a bonus of 60% from the
