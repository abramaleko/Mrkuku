        ...
        <div class="contact-form">
            <form action="" autocomplete="off">
                ...
                <div class="mt-14">
                    ...
                    <label class="block my-12 ml-8">
                        <span class="text-lg text-gray-700">Message</span>
                        <textarea class="block mt-1 text-left rounded-md" rows="3">
                                    </textarea>
                    </label>

                    <div class="block my-12 ml-8">
                        <input type="hidden" name="recaptcha" id="recaptcha">
                    </div>

                    <button
                        class="flex justify-center px-12 py-4 mx-4 ml-8 tracking-widest text-white uppercase bg-gray-800 border border-transparent rounded-md hover:bg-gray-600">
                        SUBMIT
                    </button>
                </div>
            </form>
