    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Connecting Investors with the Agri-business</h1>

                <p class="taext-gray-500 dark:text-gray-300">
            ...
            <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Vetted Projects from Industry Experts</h1>
            ...
            <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                ...
                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Our Shared Incentive: Return Cash to Investors</h1>
