...
<body>
    ...
    @if ($invoice->logo)
        <div style="display: flex">
            <img src="{{ $invoice->getLogo() }}" alt="logo" height="90">
            <p id="kuku" style="margin-left: 6.4rem; margin-top:-2rem;">Kuku</p>
        </div>
    @endif
        ...
        <tbody>
            <tr>
                ...
                <td class="pl-0 border-0">
                    ...
                    @endif
                    <p>Invoice # : <strong>INV-{{ $invoice->getCustomData() }}</strong></p>
    ...
    <p>
        {{ trans('invoices::invoice.pay_until') }}: <strong> {{ $invoice->getPayUntilDate() }} </strong>
    </p>
