        ...
        <div class="flex flex-col w-full h-full px-4 py-6 bg-white">
            ...
            <div class="flex flex-row items-center px-6 py-4 shadow rounded-2xl">
              ...
              <ul class="flex flex-row items-center space-x-1">
                  @if ($investorRequest->resolved)
                     <li class="px-2 py-2 text-xs text-white bg-gray-900 cursor-not-allowed lg:text-base lg:py-3 lg:px-6">RESOLVED</li>
                  @else
                  <li>
                                ...
                                <div class="flex flex-row lg:items-center">
                                    <div class="flex items-center justify-center flex-shrink-0 w-12 h-12">
                                        <img src="{{ $message->user->profile_photo_url }}"
                                            alt="{{ $message->user->name }}" class="w-full h-full font-bold rounded-full">
                                    </div>
            ...
            <div class="flex flex-row items-center">
                <div class="flex flex-row items-center w-full h-12 px-2">
                  <div class="w-full">
                    <input wire:model="messageInput" wire:keydown.enter="sendMessage"
                          type="text"
                           class="flex items-center w-full text-sm border h-14 focus:outline-none rounded-3xl" placeholder="Type your message....">
                  </div>
                  <!-- attachments field -->
    ...
    @endif
        ...
        <x-jet-confirmation-modal wire:model="confirmResolve">
            ...
            <x-slot name="content">
                Are you sure you want to resolve this issue request? Once your resolved, you can no longer respond to this requeest.
            </x-slot>
