                ...
                <header class="flex flex-wrap px-5 py-4 border-b border-gray-100 lg:justify-between ">
                    <div class="">
                        <h2 class="pt-4 text-lg font-semibold text-gray-800">
                            Verified Slips by {{Auth::user()->name}}
                        </h2>
                    </div>
                    <div class="">
                        <div class="relative pt-2 mx-auto text-gray-600">
                            <input
                                ...
                                type="search" wire:model="searchVerified" placeholder="Search by name"
                                autocomplete="off">
                ...
                <div class="pb-2">
                    <div class="overflow-x-auto">
                        <table class="w-full table-auto">
                            <thead
                                class="py-4 text-xs font-semibold text-black uppercase bg-gray-50">
                                <tr>
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                <div wire:loading.delay wire:target="searchVerified">
                                    <span class="py-6 pl-8 text-base text-blue-800">
                                        Searching...
                                    </span>
                                </div>
                                @foreach ($verifiedSlips as $slip)
                                <tr class=" lg:hover:bg-blue-100">
                                    ...
                                    <td class="flex justify-start p-4 whitespace-nowrap">
                                        <div
                        ...
                        <h3 class="my-4 text-lg text-center text-green-600 lg:text-2xl text-wide">
                            There are no verified slips by you
                        </h3>
                        @endif
                    </div>
                </div>
