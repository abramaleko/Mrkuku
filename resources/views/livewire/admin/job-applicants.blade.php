<div>
    ...
    @if (! $applicantDetails)
    <a href="{{route('jobDashboard')}}" class="block px-8 pt-2 text-lg font-bold text-blue-700 hover:underline"> &#8612;GO BACK</a>
        <div class="px-8 py-4">
                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-md shadow-lg ">
                        <header class="flex flex-wrap px-5 py-4 border-b border-gray-100 lg:justify-between">
                            <div class="">
                                ...
                                <a href="{{route('shortListed',$job->id)}}" class="block my-2 text-xs font-semibold tracking-wide text-gray-600 hover:text-blue-700 hover:underline" >
                                ...
                                <table class="w-full table-auto">
                                    <thead class="text-xs font-semibold text-gray-400 uppercase bg-gray-50 ">
                                        <tr>
                                            ...
                                            <th class="p-2 whitespace-nowrap">
                                                <div class="font-semibold text-center">Applied On</div>
                                            </th>
                                            <th class="p-2 whitespace-nowrap">
    ...
    @else
     <div class="p-8">
        ...
        <div class="mt-8">
            ...
            <button wire:click="downloadFiles"
            class="px-6 py-4 my-4 text-white bg-purple-700 rounded hover:bg-purple-500">
                DOWNLOAD FILES
            </button>
        </div>
     </div>
