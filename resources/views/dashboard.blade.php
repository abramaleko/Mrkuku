<x-app-layout>
    ...
    <div class="container px-6 py-8 mx-auto">
        ...
        <h1 class="text-2xl font-bold text-gray-700 lg:text-4xl lg:py-0">Dashboard</h1>
                    ...
                    <a href="#blogposts">
                        <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                            <div class="p-3 bg-indigo-600 bg-opacity-75 rounded-full">
                                <svg class="w-8 h-8" viewBox="-29 0 487 487.71802" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <a href="">
                        <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                            <div class="p-3 bg-pink-600 bg-opacity-75 rounded-full">
                                <svg id="Capa_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" class="w-8 h-8"
        ...
        <div class="mt-8">
           <h2 class="text-lg font-light tracking-wide text-gray-700 lg:text-xl mb-7">
               Hey {{Auth::user()->name}}, it looks like you have not yet invested in any of our projects.
            </h2>
            <a href="{{route('investor.myInvestments')}}"
            class="px-8 py-4 font-light tracking-wide text-white bg-blue-500 hover:bg-blue-400">
                START INVESTING NOW
            </a>
        </div>
